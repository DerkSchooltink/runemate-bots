...
class OreSmithing : ExtendedTask<Citadel>() {
    ...
    override fun validate(): Boolean {
        ...
        trough = GameObjects.newQuery().names("Water Trough").actions("Empty").results().nearest()
        oreContainer = GameObjects.newQuery().names("Ore Container", "Ore container").actions("Shovel").results().nearest()
